...
object TemplatesControllerSpec extends MockedServices {
  ...
  def templates = {
    ...
    client.getTemplates(OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, mockedResponse))
  ...
  def delete = {
    ...
    client.deleteTemplate("someTemplate", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def create = {
    ...
    client.createTemplate("someTemplate", template, OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
