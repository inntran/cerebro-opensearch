...
import opensearch.Success
import models.{OpenSearchServer, Host}
...
object OverviewControllerSpec extends MockedServices {
  ...
  def deleteIndex = {
    ...
    client.deleteIndex("a,b,c", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def refreshIndex = {
    ...
    val body = Json.obj("host" -> "somehost", "indices" -> "a,b,c")
    client.refreshIndex("a,b,c", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def flushIndex = {
    ...
    val body = Json.obj("host" -> "somehost", "indices" -> "a,b,c")
    client.flushIndex("a,b,c", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def clearIndexCache = {
    ...
    val body = Json.obj("host" -> "somehost", "indices" -> "a,b,c")
    client.clearIndexCache("a,b,c", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def forceMerge = {
    ...
    val body = Json.obj("host" -> "somehost", "indices" -> "a,b,c")
    client.forceMerge("a,b,c", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def openIndices = {
    ...
    val body = Json.obj("host" -> "somehost", "indices" -> "a,b,c")
    client.openIndex("a,b,c", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def closeIndices = {
    ...
    val body = Json.obj("host" -> "somehost", "indices" -> "a,b,c")
    client.closeIndex("a,b,c", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def shardStats = {
    ...
    client.getShardStats("someIndex", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedStats))
    client.getIndexRecovery("someIndex", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedRecovery))
  ...
  def enableShardAllocation = {
    ...
    val body = Json.obj("host" -> "somehost", "indices" -> "a,b,c")
    client.enableShardAllocation(OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def disableShardAllocation = {
    ...
    client.disableShardAllocation(OpenSearchServer(Host("somehost", None)), "none") returns Future.successful(Success(200, expectedResponse))
  ...
  val expectedShardStats = Json.parse(
    """
      ...
      |  },
      |  "shard_path": {
      |    "state_path": "/path/to/opensearch-2.3.0/data/opensearch/nodes/0",
      |    "data_path": "/path/to/opensearch-2.3.0/data/opensearch/nodes/0",
