...
class CommonsControllerSpec extends MockedServices {
  ...
  def indices = {
    ...
    client.getIndices(OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def getIndexMapping = {
    ...
    client.getIndexMapping("someIndex", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def getIndexSettings = {
    ...
    val body = Json.obj("host" -> "somehost", "index" -> "someIndex")
    client.getIndexSettings("someIndex", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
  ...
  def getNodeStats = {
    val expectedResponse = Json.parse(
      """
        ...
        |        "data": [
        |          {
        |            "path": "/path/to/opensearch-2.3.0/data/opensearch/nodes/0",
        |            "mount": "/ (/dev/disk1)",
        |            "type": "hfs",
        |            "total_in_bytes": 249804886016,
        |            "free_in_bytes": 100962553856,
    ...
    client.nodeStats("someNode", OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, expectedResponse))
