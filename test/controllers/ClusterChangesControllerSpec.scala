...
object ClusterChangesControllerSpec extends MockedServices {
  ...
  def get = {
    ...
    client.executeRequest("GET", "_cluster/state/blocks", None, OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, stateResponse))
    client.executeRequest("GET", "_nodes/transport", None, OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, nodesResponse))
    client.executeRequest("GET", "_aliases", None, OpenSearchServer(Host("somehost", None))) returns Future.successful(Success(200, aliasesResponse))
