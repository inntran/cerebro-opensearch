...
import opensearch.{OpenSearchResponse, Success}
...
object AnalysisControllerSpec extends MockedServices {
  ...
  def indices = {
    ...
    client.getIndices(OpenSearchServer(Host("somehost"))) returns Future.successful(Success(200, expectedResponse))
  ...
  def analyzers = {
    ...
    client.getIndexSettings("foo", OpenSearchServer(Host("somehost"))) returns Future.successful(Success(200, expectedResponse))
  ...
  def fields = {
    ...
    client.getIndexMapping("foo", OpenSearchServer(Host("somehost"))) returns Future.successful(Success(200, expectedResponse))
  ...
  def analyzeByAnalyzer = {
    ...
    client.analyzeTextByAnalyzer("foo", "bar", "qux", OpenSearchServer(Host("somehost"))) returns Future.successful(Success(200, expectedResponse))
  ...
  def analyzeByField = {
    ...
    client.analyzeTextByField("foo", "bar", "qux", OpenSearchServer(Host("somehost"))) returns Future.successful(Success(200, expectedResponse))
