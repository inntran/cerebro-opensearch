...
object ClusterOverviewSpec extends Specification {
  ...
  def clusterName = {
    (clusterWithoutData \ "cluster_name").as[String] mustEqual "opensearch"
    (clusterWithData \ "cluster_name").as[String] mustEqual "opensearch"
    (clusterInitializing \ "cluster_name").as[String] mustEqual "opensearch"
    (clusterRelocating \ "cluster_name").as[String] mustEqual "opensearch"
  }
