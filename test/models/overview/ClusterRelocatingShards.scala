...
object ClusterRelocatingShards extends ClusterStub {
  ...
  val nodesStats = Json.parse(
    """
      ...
      |        },
      |        "data" : [ {
      |          "path" : "/path/to/opensearch-2.1.0/data/opensearch/nodes/1",
      |          "mount" : "/ (/dev/disk1)",
      |          "type" : "hfs",
      |          "total_in_bytes" : 249804886016,
      |          "free_in_bytes" : 40472023040,
      ...
      |        },
      |        "data" : [ {
      |          "path" : "/path/to/opensearch-2.1.0/data/opensearch/nodes/2",
      |          "mount" : "/ (/dev/disk1)",
      |          "type" : "hfs",
      |          "total_in_bytes" : 249804886016,
      |          "free_in_bytes" : 40471994368,
      ...
      |        },
      |        "data" : [ {
      |          "path" : "/path/to/opensearch-2.1.0/data/opensearch/nodes/0",
      |          "mount" : "/ (/dev/disk1)",
      |          "type" : "hfs",
      |          "total_in_bytes" : 249804886016,
      |          "free_in_bytes" : 40472023040,
